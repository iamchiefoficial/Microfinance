# Simple Working Microfinance System - No Threading
...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'simple_microfinance_2025'
...
<body>
    <div class="login-container">
        <div class="logo">
            ...
            <p>Simple Working System <span class="python-indicator">PYTHON</span> <span class="auto-refresh">AUTO-REFRESH</span></p>
        </div>
...
if __name__ == '__main__':
    print("🚀 Starting Simple Working Microfinance Platform...")
    print("🌐 Access at: http://127.0.0.1:5000")
    print("✅ Features: No Threading, Simple & Reliable")
    print("🔄 Auto-refresh Every 15 Seconds")
    print("🔑 Staff Password: mf@123")
    print("💼 Production-Ready Simple Banking System")
