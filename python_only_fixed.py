# Fixed Python Microfinance System - No JavaScript Required
...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'python_only_microfinance_2025'
...
# Global variable for real-time updates
system_stats = {
...
<head>
    ...
    <style>
        ...
        .python-indicator { background: #3776ab; color: white; padding: 5px 10px; border-radius: 20px; font-size: 12px; display: inline-block; margin-top: 10px; }
        .auto-refresh { background: #ff9800; color: white; padding: 3px 8px; border-radius: 12px; font-size: 11px; display: inline-block; margin-left: 5px; }
    </style>
</head>
<body>
    <div class="login-container">
        <div class="logo">
            ...
            <p>Python-Only System <span class="python-indicator">PYTHON</span> <span class="auto-refresh">AUTO-REFRESH</span></p>
        </div>
...
<body>
    <div class="register-container">
        <div class="logo">
            <h1>🏦 Microfinance Platform</h1>
            <p>Create Your Account <span class="python-indicator">PYTHON</span> <span class="auto-refresh">AUTO-REFRESH</span></p>
        </div>
...
def dashboard():
    ...
    # Get real-time statistics from global variable
    ...
    # Format the portfolio amount
    portfolio_amount = f"${stats['total_loan_amount']:,.0f}"
...
<head>
    ...
    <style>
        ...
        .python-indicator {{ background: #3776ab; color: white; padding: 5px 10px; border-radius: 20px; font-size: 12px; display: inline-block; margin-left: 10px; }}
        .auto-refresh {{ background: #ff9800; color: white; padding: 3px 8px; border-radius: 12px; font-size: 11px; display: inline-block; margin-left: 5px; }}
        .last-update {{ color: #666; font-size: 12px; margin-top: 5px; }}
    </style>
</head>
<body>
    <div class="container">
        <div class="header">
            <div>
                <h1>🏦 Microfinance Platform <span class="python-indicator">PYTHON</span> <span class="auto-refresh">AUTO-REFRESH</span></h1>
                <h2>Welcome, {user.full_name}!</h2>
                <p class="last-update">Last updated: {stats['last_update'].strftime('%Y-%m-%d %H:%M:%S')}</p>
            </div>
            <div class="user-info">
        ...
        <div class="content">
            <div class="stats-grid">
                ...
                <div class="stat-card card-green">
                    <h3>Total Loans</h3>
                    <div class="number">{stats['total_loans']}</div>
                    <div class="label">All applications</div>
                </div>
                <div class="stat-card card-orange">
                    <h3>Pending Loans</h3>
                    <div class="number">{stats['pending_loans']}</div>
                    <div class="label">Awaiting approval</div>
                </div>
                <div class="stat-card card-red">
                    <h3>Approved Loans</h3>
                    <div class="number">{stats['approved_loans']}</div>
                    <div class="label">Active loans</div>
                </div>
                <div class="stat-card card-purple">
                    <h3>Portfolio Value</h3>
                    <div class="number">{portfolio_amount}</div>
...
if __name__ == '__main__':
    print("🚀 Starting Fixed Python Microfinance Platform...")
    print("🌐 Access at: http://127.0.0.1:5000")
    print("✅ Features: No JavaScript - Pure Python Auto-Refresh")
    print("🔄 Automatic Updates Every 10 Seconds")
    print("🔑 Staff Password: mf@123")
    print("💼 Production-Ready Python-Only Banking System")
