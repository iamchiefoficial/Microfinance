        ...
        <div class="main-content">
            <div class="header">
                <div class="header-content">
                    <div><h1>Manage Users</h1><p>View and manage all system users</p></div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{% if user.role != 'admin' %}<form method="POST" action="/admin/delete_user/{{ user.id }}" onsubmit="return confirm('Delete this user?')"><button type="submit" class="btn">Delete</button></form>{% else %}<span style="color:#999;">Protected</span>{% endif %}</td>
                        </tr>
                        {% endfor %}
                    </tbody>
                </table>
...
print('✅ admin_users.html fixed with full height sidebar!')
