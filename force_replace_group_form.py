# force_replace_group_form.py
import os

# Force delete the existing form file
form_path = 'templates/group_loan_form.html'
if os.path.exists(form_path):
    os.remove(form_path)
    print('✅ Deleted existing group_loan_form.html')

# Create the complete new multi-page form
...
print('🎉 NEW MULTI-PAGE GROUP LOAN FORM FORCIBLY REPLACED!')
print('📋 Features: 6 pages, navigation, table ONLY on page 5')
print('🔄 Please clear browser cache (Ctrl+F5) and try again')
